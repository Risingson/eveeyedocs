...
`solarsystem` *2spaces* `clr` or `clear`: Sets a system empty
`character` *2spaces* `solarsystem` *2spaces* `+5`: Will add +5 or any other number you entered 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ0NDY2NTY4NCwxMDE2NDUzMjgzLDExMz
