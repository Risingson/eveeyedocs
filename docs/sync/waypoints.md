...
!!! attention "Ingame vs Eveeye route"
    You should match ingame and eveeye settings to get the same routes ingame and within eveeye. Still routes displayed may not match 100% every time. Eveeye will detect and re-calc the route if you took a different path though.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAyMDA5NTUxNCw3NTI0MjczMTAsLTE3Mj
