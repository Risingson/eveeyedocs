...
In the same menu you can select `Avoid System`. To mange your avoided systems goto the Routing options in Settings menu.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjE3ODYzNzUwLC0xODA1NTg2NDU1XX0=
-->