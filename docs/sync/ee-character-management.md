...
## Discord Login 
This app uses the [Discord oauth login](https://discord.com/developers/docs/topics/oauth2) to authenticate characters. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIxODgxNjA3NiwtOTA3MjE0MDcyLC0xMz
