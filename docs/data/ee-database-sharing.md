...
Anyone else that is authenticated on Eveeye with a user on that same discord server will be able to seet that map within his set list and be able to adto add the map to his sets.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjMwMzU5MDkzXX0=
-->